...
export default function App(){
  ...
  return (
    <div className=" bg-slate-950 h-screen w-screen grid place-content-center">
      <button className=" bg-indigo-500 rounded px-4 py-2 text-white transition-colors hover:bg-indigo-600"
